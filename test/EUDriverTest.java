...
public class EUDriverTest {
        ...
        public void listMEPsbyPartyName() {
           ...
           assertTrue(euDriver.listMEPsbySpecificParty("anything").contains("There are no"));//contains is a string method
    ...
    public void findCountry() {
        ...
        assertEquals("Ireland", euDriver.findCountry("Ireland").getName());//fixed
